		  		...
		  		<div class="col-md-6">
		  			<div class="conten-box-large">
                          ...
                          <div class="form-group">
                                                    ...
                                                    <div class="form-group">      
                               <input type="text" name="question" placeholder="" style="border-radius:3px; width:400px; height:40px;">
                               </div>
                                                    ...
                                                    <div class="form-group">   
                                                        <textarea required class="form-control" rows="8"  cols="11" name="answer" ></textarea>
                                                    </div>
                                                </div>
